...
/*   setTimeout(doSomething, 3000);
  ...
  return (
    <div className="body">
          ...
          <div ng-app ng-init="checked = false">
            <form className="form-signin" action method="post" name="form">
              ...
              <div className="btn-animate">
                <a className="btn-signin" href type="button" onClick={Login}>
                  Continue
                </a>
              </div>
            </form>
      ...
      <br />
      <br />
      <div className="span">New to miniBell?</div>
      <div className="btn1">
        <div className="btn-animate">
          <a className="btn-signin" type="button" href="/signup">
            Create you miniBell acount
          </a>
        </div>
      </div>
    </div>

...
function Navbar1() {
  ...
  if (firstName === null) {
    menu = (
      <>
        <MenuItem>
          <Button3 style={{ padding: "10px 10px", width: "70px" }}>
            <Link
              to={"/signin"}
    ...
    menu = (
      <>
        <MenuItem>
          <Button3
            style={{ padding: "10px 10px", width: "100px" }}
            onClick={() => logOut()}
          >
            <Link
              to={"/signin"}
      ...
      <>
        <Wrapper>
          ...
          <Right>
            ...
            <Avatar alt="Remy Sharp" src={profile.companylogourl} />
